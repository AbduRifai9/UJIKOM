            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">WaveFest</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-4"><center>Welcome to WaveFest 👋👋</center></h4>
      ...
      <div class="authentication-inner">
        <div class="card shadow-lg border-0 rounded-4">
          <div class="card-body p-4">
            ...
            <h4 class="text-center mb-2">Selamat Datang {{ auth()->user()?->role == 'admin' ? 'Admin' : 'User' }} 👋</h4>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                    value="{{ old('email') }}" required autofocus placeholder="Email kamu">
                </div>
                @error('email')
